...
-- What are you doing here? That's kinda sus ngl.
-- Go back up and modify those values,
-- don't mess with what's down here. >:(

local defaults = {}
defaults.playerSpeed = 120
defaults.playerGravity = 600
defaults.enemySpeed = 30

if switchToDefaults then
